<div class="bg-login" style="width: 100%; height: 100vh">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <form class="bg-white  p-3 rounded-p shadow" style="height: 550px;" method="POST" action="/">
                        ...
                        <div  class="col-12 align-self-end pt-5">
                            <p class="form-text pt-5">¿No tienes una cuenta? <a href="/Pagina/crear" class="text-decoration-none">Registrate</a> </p>
                        </div>
                    </form>
                </div>
            </div>
