            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label class="form-label required">Diferencia</label>
                            <input type="number" class="form-control">
                        </div>
...
<div class="rounded-p m-5">
                    ...
                    <tbody>        
                        <tr>
                            ...
                            <td class="acciones-edit">
                                <button type="button" class="btn actualizar" data-bs-toggle="modal" data-bs-target="#myModal">
                                ...
                                <form action="/Dashboard/eliminar" method="POST" id="btn-eliminar">
                                    <input type="hidden" name="id" value="dasdas?>">
    ...
    <button type="button" class="btn btn-success btn-gasto mt-5" data-bs-toggle="modal" data-bs-target="#myModal">Agregar Gasto</button>
</div>
