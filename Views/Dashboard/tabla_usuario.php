<div class="bg-body container rounded-p m-5">
    <div class="row">
        <div class="col-12"><h1 class="h2 text-center ">Tabla de Usuarios</h1></div>
    </div>
    <div class="row">
        <div class="col-12 d-flex">
            <a href="#modal" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                ...
                <table class="table table-hover table-sm ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><p name="cve_usuario"></p></td>
                            <td><p name="usuario[nombre_usuario, apellidopa_usuario, apellidoma_usuario]"></td>
                            <td name="usuario[usuario_usuario]"></td>
                            <td name="usuario[cverol_usuario]"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="radio" name="cve_usuario" id=""></td>
                            <td>789</td>
                            <td>Adipisicing elit nisi</td>
                            <td>Adipisicing_elit</td>
                            <td>dolor</td>
                        </tr>
                    </tbody>
                </table>
