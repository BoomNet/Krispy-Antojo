                        ...
                        <tbody>
                            ...
                            <?php foreach($allUsers as $user):?>
                                <tr>
                                    ...
                                    <td><?php echo $user['nombre_productos']?></td>
                                    <td><?php echo $user['precioCompra_producto']?></td>
                                    <td><?php echo $user['precioVenta_producto']?></td>
                                    <td><?php echo $user['strock_producto']?></td>
